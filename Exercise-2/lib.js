...
var KhmerDate = /** @class */ (function () {
    function KhmerDate(dateTime) {
        this.date = new Date();
        this.currentDate = new Date();
        this.date = new Date(dateTime);
        var LastDate = this.date.getTime() / 1000;
        console.log("Last Date: ", dateTime);
        this.currentTimeStamp(LastDate);
    }
    KhmerDate.prototype.currentTimeStamp = function (LastDate) {
        var currentSeconds = (this.currentDate.getTime() / 1000) + 7 * 60 * 60;
        var result = currentSeconds - LastDate;
